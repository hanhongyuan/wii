...
public class RedisManage {
    ...
    private Logger logger = LoggerFactory.getLogger(RedisManage.class);
...
//    }
    ...
    Consumer<Transaction> tranc){
        ...
        try {
            ...
            tranc.accept(transaction);
            transaction.execGetResponse();
        }
        catch(Exception e) {
            logger.info("transaction  handle exception: " + e.getMessage());
            isBroken = true;
        }
        finally {
            release(jedis, isBroken);
