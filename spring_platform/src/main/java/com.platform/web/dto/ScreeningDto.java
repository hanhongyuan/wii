...
public class ScreeningDto {
    ...
    /** 消费频率 */
    private int avgVisitDaysStart;
    /** 消费频率 */
    private int avgVisitDaysEnd;
    /** 门店信息 */
    private int storeId;
    /** 分店门店id */
    private String branchStoreIds;

    public int getAvgVisitDaysEnd() {
        return avgVisitDaysEnd;
    }

    public void setAvgVisitDaysEnd(int avgVisitDaysEnd) {
        this.avgVisitDaysEnd = avgVisitDaysEnd;
    }

    public int getAvgVisitDaysStart() {
        return avgVisitDaysStart;
    }

    public void setAvgVisitDaysStart(int avgVisitDaysStart) {
        this.avgVisitDaysStart = avgVisitDaysStart;
    }
